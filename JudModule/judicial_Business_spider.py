...
class SuccessCODE():
    ...
    def __init__(self):
        ...
        self.coll_2 = self.client_01["guangdong"]["法院公告"]
        self.coll_3 = self.client_01["guangdong"]["经营异常"]
        self.coll_4 = self.client_01["guangdong"]["限制消费"]
        self.coll_5 = self.client_01["guangdong"]["裁判文书"]
        self.coll_6 = self.client_01["guangdong"]["被执行人"]
        self.coll_7 = self.client_01["guangdong"]["失信被执行人"]
        self.coll_8 = self.client_01["guangdong"]["行政处罚"]
        self.coll_9 = self.client_01["guangdong"]["股权冻结"]

        self.coll_2_1 = self.client["guangdong"]["法院公告"]
        self.coll_3_1 = self.client["guangdong"]["经营异常"]
        self.coll_4_1 = self.client["guangdong"]["限制消费"]
        self.coll_5_1 = self.client["guangdong"]["裁判文书"]
        self.coll_6_1 = self.client["guangdong"]["被执行人"]
        self.coll_7_1 = self.client["guangdong"]["失信被执行人"]
        self.coll_8_1 = self.client["guangdong"]["行政处罚"]
        self.coll_9_1 = self.client["guangdong"]["股权冻结"]

        self.col = self.client["guangdong"]["fail_sifa_companyid"]
        self.headers=dict()
        self.sfaj_item=list()
    ...
    def Restrain(self, info,page):
        while True:
            try:
                ...
                info["page"] = page
                self.col.insert_one(info)
        self.local_conn.sadd("guangdong:filter:cpws_com", info["company"])
                ...
                if res is None:
                    ...
                    with ThreadPoolExecutor(3) as f:
                        ...
                        while True:
                            ...
                            for info in data[_:]:
                                try:
                                    if not self.local_conn.sismember("guangdong:filter:cpws_com", info["company"]):
