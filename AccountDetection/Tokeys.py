...
local_VQ_conn = redis.Redis(host='192.168.5.181', port=7933, db=0, password="fer@nhaweif576KUG",socket_connect_timeout=11170)
...
def demo():
	...
	for _ in range(4):
		...
		local_VQ_conn.lpush("searchMobil",res)
