...
class LoginModule:
    ...
    def __init__(self):
        ...
        self.local_conn = redis.Redis(host='127.0.0.1', port=7980, db=0, password="qwe!@#SDF345788",socket_connect_timeout=170)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if res["message"]=="":
                    ...
                    self.local_VQ_conn.lrem("searchMobil", 1, json.dumps(self.Reqest["mobil"]))
