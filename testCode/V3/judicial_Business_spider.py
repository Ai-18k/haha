        ...
        while True:
            try:
                ...
                if response.status_code == 200:
                    if response.json()["state"] == "ok" and response.json()['message'] == "":
                        ...
                        for item in info_list:
                            ...
                            self.ncp_coll.insert_one(json_data)
                            if "_id" in json_data:
                                del json_data["_id"]
                ...
                if "_id" in info:
                    del info["_id"]
                try:
                    self.f_ncp_coll.insert_one(info)
                    print("数据插入成功！")
        ...
        while True:
            try:
                ...
                if response.status_code == 200:
                    if response.json()["state"] == "ok" and response.json()['message'] == "":
                        ...
                        for item in info_list:
                            ...
                            self.nfy_coll.insert_one(json_data)
                            if "_id" in json_data:
                                del json_data["_id"]
                ...
                if "_id" in info:
                    del info["_id"]
                try:
                    self.f_nfy_coll.insert_one(info)
                    print("数据插入成功！")
                except errors.DuplicateKeyError:
                    print("数据已存在，插入失败！")
        ...
        while True:
            try:
                ...
                if response.status_code == 200:
                    if "data" in response.json() and response.json()["data"] and response.json()['message'] != "登录后可查看更多" and response.json()["errorCode"] == 0 and response.json()["errorCode"]!="303000":
                            ...
                            for item in info_list:
                                ...
                                self.nzx_coll.insert_one(json_data)
                                if "_id" in json_data:
                                    del json_data["_id"]
                ...
                if "_id" in info:
                    del info["_id"]
                try:
                    self.f_nzx_coll.insert_one(info)
                    print("数据插入成功！")
                except errors.DuplicateKeyError:
                    print("数据已存在，插入失败！")
        ...
        while True:
            try:
                        ...
                        if response.json()["data"]:
                            if response.json()['message'] != "登录后可查看更多":
                                ...
                                for item in info_list:
                                    ...
                                    self.nszx_coll.insert_one(json_data)
                                    if "_id" in json_data:
                                        del json_data["_id"]
                                    logger.info(f"第 {page} 页数据！！")
                                    self.send_data(3, json_data)
                ...
                if "_id" in info:
                    del info["_id"]
                try:
                    self.f_nszx_coll.insert_one(info)
                    print("数据插入成功！")
                except errors.DuplicateKeyError:
                    print("数据已存在，插入失败！")
        ...
        while True:
            try:
                ...
                if response.status_code == 200:
                    if response.json()['state'] == "ok" and response.json()['message'] == "":
                        ...
                        for item in info_list:
                                ...
                                self.nxz_coll.insert_one(json_data)
                                if "_id" in json_data:
                                    del json_data["_id"]
                ...
                if "_id" in info:
                    del info["_id"]
                try:
                    self.f_nxz_coll.insert_one(info)
                    print("数据插入成功！")
                except errors.DuplicateKeyError:
                    print("数据已存在，插入失败！")
        ...
        while True:
            try:
                        ...
                        if response.json()["data"]:
                            if response.json()['message'] == "":
                                ...
                                for item in info_list:
                                    ...
                                    self.ngq_coll.insert_one(json_data)
                                    if "_id" in json_data:
                                        del json_data["_id"]
                ...
                if "_id" in info:
                    del info["_id"]
                try:
                    self.f_ngq_coll.insert_one(info)
                    print("数据插入成功！")
                except errors.DuplicateKeyError:
                    print("数据已存在，插入失败！")
        ...
        while True:
            try:
                        ...
                        if response.json()["data"]:
                            if response.json()['message'] != "登录后可查看更多":
                                ...
                                for item in info_list:
                                    ...
                                    logger.info(json_data)
                                    self.njy_coll.insert_one(json_data)
                                    if "_id" in json_data:
                                        del json_data["_id"]
                ...
                if "_id" in info:
                    del info["_id"]
                try:
                    self.f_njy_coll.insert_one(info)
                    print("数据插入成功！")
                except errors.DuplicateKeyError:
                    print("数据已存在，插入失败！")
        ...
        while True:
            try:
                    ...
                    if response.json()["errorCode"] == 0 and response.json()['message'] != "登录后可查看更多":
                        if response.json()["data"]:
                            ...
                            for item in info_list:
                                    ...
                                    logger.info(json_data)
                                    self.nxf_coll.insert_one(json_data)
                                    if "_id" in json_data:
                                        del json_data["_id"]
                ...
                if "_id" in info:
                    del info["_id"]
                try:
                    self.f_nxf_coll.insert_one(info)
                    print("数据插入成功！")
                except errors.DuplicateKeyError:
                    print("数据已存在，插入失败！")
            ...
            try:
                ...
                if res is None:
                    ...
                    with ThreadPoolExecutor(3) as f:
                        ...
                        _ = 1
                        while True:
                            res = self.local_conn.lpop(self.nsc_area_key)
                            if res is None:
                                time.sleep(0.5)
                            else:
                                ...
                                print(info)
                                try:
                                    if not self.local_conn.sismember(self.nsc_filter_key, info["company"]):
                                    ...
                                    _ += 1
                                    for obj_list in [obj_list1, obj_list2, obj_list3, obj_list4, obj_list5, obj_list6,
                                                     obj_list7, obj_list8]:
                                        if len(obj_list) >= 20:
                                    ...
                                    logger.error(e)
                        for obj_list in [obj_list1, obj_list2, obj_list3, obj_list4,
                                         obj_list5, obj_list6, obj_list7, obj_list8]:
                            for future in obj_list:
                                try:
                                    future.result()
                                except Exception as e:
